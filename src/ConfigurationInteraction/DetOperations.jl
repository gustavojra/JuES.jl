"""
    JuES.ConfigurationInteraction.DetOperations
...
"""
    JuES.ConfigurationInteraction.DetOperations.Determinant
...
"""
    JuES.ConfigurationInteraction.DetOperations.Determinant(α::String, β::String)
...
"""
    JuES.ConfigurationInteraction.DetOperations.αlist(D::Determinant)
...
"""
    JuES.ConfigurationInteraction.DetOperations.βlist(D::Determinant)
...
"""
    JuES.ConfigurationInteraction.DetOperations.αexcitation_level(D1::Determinant, D2::Determinant)
...
"""
    JuES.ConfigurationInteraction.DetOperations.βexcitation_level(D1::Determinant, D2::Determinant)
...
"""
    JuES.ConfigurationInteraction.DetOperations.excitation_level(D1::Determinant, D2::Determinant)
...
"""
    JuES.ConfigurationInteraction.DetOperations.αexclusive(D1::Determinant, D2::Determinant)
...
"""
    JuES.ConfigurationInteraction.DetOperations.βexclusive(D1::Determinant, D2::Determinant)
...
"""
    JuES.ConfigurationInteraction.DetOperations.exclusive(D1::Determinant, D2::Determinant)
...
"""
    JuES.ConfigurationInteraction.DetOperations.annihilate(D::Determinant, orb::Int, spin::Char)
...
"""
    JuES.ConfigurationInteraction.DetOperations.create(D::Determinant, orb::Int, spin::Char)
...
"""
    JuES.ConfigurationInteraction.DetOperations.phase(D::Determinant, l::Int=0)
